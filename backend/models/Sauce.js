...
const mongooseErrors = require('mongoose-errors'); //intercepte les erreur mongooses pour retourner une reposne http avec l'erreur mongo
...
const sauceSchema = mongoose.Schema({
  ...
  usersLiked: { type: [String], required: true }, // tableau des identifiants des utilisateurs qui ont aimé
  usersDisliked: { type: [String], required: true} // tableau des identifiants des utilisateurs qui n'ont pas aimé
});
